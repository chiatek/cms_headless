            ...
            <div class="container">
                ...
                <div class="row no-gutters overflow-hidden">
                    <div class="col-lg-2 pt-0">
                        ...
                        <div class="pr-5">
                            <div class="list-group list-group-transparent mb-0">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo site_url('database/saved_query'); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                                ...
                                <?php if ($user->user_role == "administrator"): ?>
                                    ...
                                    <a href="<?php echo site_url('database/table'); ?>" class="list-group-item list-group-item-action d-flex align-items-center active">
                    ...
                    <div class="col-lg-10 mt-70">
                        ...
                        <form action="<?php echo site_url('database/table/'.$table); ?>" method="post" id="database-form">
