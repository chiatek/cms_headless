                ...
                <div class="row no-gutters overflow-hidden">
                    ...
                    <div class="col-md-9 mt-35">
                        <div class="card tab-content">
                            ...
                            <div class="tab-pane fade show active" id="account">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo site_url('users/reset_password/'.$row->user_id); ?>" class="small">Reset password</a>
                                        <?php if ($error == 0): ?>
                            ...
                            <form action="<?php echo site_url('users/edit/'.$pkey_val); ?>" method="post" id="user-form">
