                        ...
                        <div class="pr-5">
                            <div class="list-group list-group-transparent mb-0">
                                ...
                                <?php if ($user->user_role == "administrator"): ?>
                                    ...
                                    <a href="<?php echo site_url('database/insert_column/'.$table); ?>" class="list-group-item list-group-item-action d-flex align-items-center">
                                    ...
                                    if (isset($table)) {
                                        ...
                                        for ($i = 0; $i < $query->rowCount(); $i++) {
                                            ...
                                            for ($j = 0; $j < $query->columnCount(); $j++) {
                                                ...
                                                echo '<td><a href="'.site_url('database/edit_column/'.$table.'/'.$key).'" class="text-dark table-link">'.$row[$col['name']].'</a></td>';
                                            }
